		...
		<>
			...
			<section className="section-static-1 position-relative bg-primary fix z-0 section-padding">
							...
							<div className="col-xl-3 col-lg-4 col-sm-6">
								<div className="counter-item-cover counter-item">
									<div className="content text-center mx-auto">
										<span className="fw-bold lh-sm count ds-2 text-100"><span className="odometer" /><CountUp end={50} enableScrollSpy={true} /><span></span></span>
										<p className="fs-5 text-100">Countries Reached</p>
									</div>
								</div>
							</div>
							<div className="col-xl-3 col-lg-4 col-sm-6">
								<div className="counter-item-cover counter-item">
									<div className="content text-center mx-auto">
										<span className="count lh-sm ds-2 fw-bold text-100">+<span className="odometer" /><CountUp end={92} enableScrollSpy={true} />%</span>
										<p className="fs-5 text-100">Recognition in Airports</p>
									</div>
								</div>
							</div>
							<div className="col-xl-3 col-lg-4 col-sm-6">
								<div className="counter-item-cover counter-item">
									<div className="content text-center mx-auto">
										<span className="count lh-sm ds-2 fw-bold text-100">+<span className="odometer" /><CountUp end={89} enableScrollSpy={true} />%</span>
										<p className="fs-5 text-100">Real-Time Optimization</p>
									</div>
								</div>
							</div>
							<div className="col-xl-3 col-lg-4 col-sm-6">
								<div className="counter-item-cover counter-item">
									<div className="content text-center mx-auto">
										<span className="count lh-sm ds-2 fw-bold text-100"><span className="odometer" /><CountUp end={230} enableScrollSpy={true} /></span>
				...
				<div className="img-decorate position-absolute top-0 start-0">
					<img src="/assets/imgs/static-1/img-decorate.png" alt="Xchange OOH" />
				</div>
