						...
						<div className="col-lg-6 col-md-12 mb-lg-0 mb-5">
							<div className="pe-2">
								<Link href="#" className="d-flex align-items-center bg-linear-1 d-inline-flex rounded-pill px-2 py-1">
									<span className="bg-primary fs-9 fw-bold rounded-pill px-2 py-1 text-white">Here</span>
									<span className="fs-7 fw-medium text-primary mx-2">Your Global OOH and DOOH Advertising Partner</span>
								...
								<h3 className="ds-3 mt-4 mb-5" data-aos="fade-zoom-in" data-aos-delay={0}>Transform the World into Your Advertising Canvas</h3>
								<p className="pe-10 mb-5" data-aos="fade-zoom-in" data-aos-delay={200}>Connect your brand with global audiences through Xchange, your leading Out-of-Home (OOH) and Digital Out-of-Home (DOOH) advertising partner.</p>
