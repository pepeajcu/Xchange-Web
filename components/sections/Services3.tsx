							...
							<div className="swiper-wrapper">
								...
								<SwiperSlide className="swiper-slide">
									<div className="card-service-4 position-relative bg-white p-6 border rounded-3 text-center shadow-1 hover-up mt-2">
										<div className="bg-primary-light icon-flip position-relative icon-shape icon-xxl rounded-3 me-5">
											<div className="icon">
												<img src="/assets/imgs/service-3/icon-3.svg" alt="infinia" />
											</div>
										</div>
										<h5 className="my-3">OOH Advertising</h5>
										<p className="mb-6">Transform everyday spaces into impactful advertising opportunities. From iconic billboards to transit stations, connect with mass audiences in effective and memorable ways.</p>
								...
								<SwiperSlide className="swiper-slide">
									<div className="card-service-4 position-relative bg-white p-6 border rounded-3 text-center shadow-1 hover-up mt-2">
										...
										<h5 className="my-3">Programmatic DOOH</h5>
										<p className="mb-6">Take your campaigns to the next level with dynamic, targeted digital ads. Control your message in real time to maximize results and optimize your investment.</p>
										<Link href="#" className="text-primary fs-7 fw-bold">
											Learm More
											<svg className=" ms-2 " xmlns="http://www.w3.org/2000/svg" width={19} height={18} viewBox="0 0 19 18" fill="none">
												<g clipPath="url(#clip0_399_9647)">
								...
								<SwiperSlide className="swiper-slide">
									<div className="card-service-4 position-relative bg-white p-6 border rounded-3 text-center shadow-1 hover-up mt-2">
										...
										<h5 className="my-3">Global Impact</h5>
										<p className="mb-6">Connect with international audiences using strategic placements in airports, shopping malls and key public spaces around the world. <br/><br/><br/></p>
										<Link href="#" className="text-primary fs-7 fw-bold">
											Learm More
											<svg className=" ms-2 " xmlns="http://www.w3.org/2000/svg" width={19} height={18} viewBox="0 0 19 18" fill="none">
												<g clipPath="url(#clip0_399_9647)">
								...
								<SwiperSlide className="swiper-slide">
									<div className="card-service-4 position-relative bg-white p-6 border rounded-3 text-center shadow-1 hover-up mt-2">
										...
										<h5 className="my-3">Innovation and Precision</h5>
										<p className="mb-6">Combine creativity and advanced technology to reach the right people at the ideal time, driving interaction and brand awareness.</p>
										<Link href="#" className="text-primary fs-7 fw-bold">
											Learm More
											<svg className=" ms-2 " xmlns="http://www.w3.org/2000/svg" width={19} height={18} viewBox="0 0 19 18" fill="none">
												<g clipPath="url(#clip0_399_9647)">
